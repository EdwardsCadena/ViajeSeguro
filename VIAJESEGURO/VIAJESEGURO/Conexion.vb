...
Public Class Conexion
    ...
    Private Sub Conexionn()
        cadena = "Data Source=.;Initial Catalog=volarseguro;Integrated Security=True"
    ...
    Public Function insertar_Hoteles_Internacionales(ByVal datos As Datos) As Boolean
        ...
        Return estado
    End Function
    Public Function Actualizar_Hoteles(ByVal datos As Datos) As Boolean
        Dim estado As Boolean = True
        Try
            Conexionn()
        ...
        Return estado
    End Function
    Public Function eliminar_Hoteles(ByVal datos As Datos) As Boolean
        Dim estado As Boolean = True
        Try
            Conexionn()
    ...
    Public Function insertar_Datoss(ByVal datos As Datos) As Boolean
        ...
        Try
            ...
            adaptador.InsertCommand.Parameters.Add("@ciud", SqlDbType.VarChar, 50).Value = datos.Ciudadess
    ...
    Public Function Actualizar_Datoss(ByVal datos As Datos) As Boolean
        ...
        Try
            ...
            adaptador.UpdateCommand.Parameters.Add("@c", SqlDbType.VarChar, 50).Value = datos.Ciudadess
    ...
    Public Shared Function Conectado()
        Try
            cnn = New SqlConnection("Data Source=.;Initial Catalog=volarseguro;Integrated Security=True")
            cnn.Open()
            Return True
        Catch ex As Exception
            MsgBox(ex.Message)
